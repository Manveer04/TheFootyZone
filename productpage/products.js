...
if (product != 0) {
    ...
    <h6><a href="shop.html">Shop</a>/${product.category}</h6> <!-- Display the category here -->
    <h3>${product.brand}</h3>
...
function createProductBoxShop(product) {
    ...
    <a class="productpg" href="productdetails.html?id=${product.productId}"><img src="../${product.imageSrc}" alt="${product.name}">
